...
let dbURI = process.env.MONGODBURI || 'mongodb+srv://tabish:1234@cluster0.wtc3jvl.mongodb.net/loginform?retryWrites=true&w=majority';
...
app.use(cors({
    origin: ['http://localhost:3001', 'https://ecom-25516.web.app', '*'],
    credentials: true
}));
